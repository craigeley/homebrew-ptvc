class Ptvc < Formula
  ...
  url "https://github.com/craigeley/ptvc/archive/refs/tags/v0.6.2.tar.gz"
  sha256 "236bf9008e0c89ad0d9dcd8a26646f462abe2fb09d3c1f1aef5a27cf589c9e7b"
  license "MIT"
  ...
  test do
    ...
    assert_match "ptvc 0.6.2", shell_output("#{bin}/ptvc --version")
  end
end
