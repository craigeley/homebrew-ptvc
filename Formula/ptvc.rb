class Ptvc < Formula
  ...
  url "https://github.com/craigeley/ptvc/archive/refs/tags/v0.5.1.tar.gz"
  sha256 "6db4b80c39e3e38c8e5722eeacbb1bda6e566a3fc54683a2fab7b33573de0a9c"
  license "MIT"
  ...
  test do
    ...
    assert_match "ptvc 0.5.1", shell_output("#{bin}/ptvc --version")
  end
end
